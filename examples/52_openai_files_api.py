...
async def main() -> None:
    model_name = example_env("TELIC_EXAMPLE_OPENAI_FILES_MODEL", "gpt-5-mini") or "gpt-5-mini"
    upload_path = example_env("TELIC_EXAMPLE_UPLOAD_FILE_PATH")
    if not upload_path:
        fail_or_skip("Set TELIC_EXAMPLE_UPLOAD_FILE_PATH to run the OpenAI Files API example.")
