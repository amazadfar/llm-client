# Tool Creation Guide For `telic`

This guide is the focused package-level rulebook for creating tools with
`telic`. It covers the tool surfaces that actually exist in this repo and
...
```python
from telic.tools import Tool, ToolExecutionMetadata
...
```python
from telic.tools import ToolResult
...
from telic.providers.types import ToolCall
from telic.tools import ToolExecutionEngine, ToolRegistry
...
```python
from telic.tools import ResponsesBuiltinTool
...
```python
from telic.tools import ResponsesConnectorId, ResponsesMCPTool
...
```python
from telic.tools import ResponsesCustomTool, ResponsesGrammar
...
- `telic/tools/base.py`
- `telic/tools/decorators.py`
- `telic/tools/execution_engine.py`
- `telic/tools/runtime.py`
- `telic/adapters/tools.py`
- `docs/telic-tool-runtime-guide.md`
