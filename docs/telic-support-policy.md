# telic Support Policy

This document defines the support expectations for the standalone `telic`
package.
...
- `telic.container` helpers when used as migration/integration shims
