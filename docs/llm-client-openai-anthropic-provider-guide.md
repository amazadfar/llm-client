...
This guide describes the provider behavior shipped in `llm-client 0.4.0`.
...
```python
from llm_client.model_catalog import get_default_model_catalog
...
`llm_client/assets/provider_source_manifest.json`. Applications making billing
