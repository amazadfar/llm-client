# telic 0.3.0 Release Notes

Last updated: 2026-04-16

`telic` `0.3.0` is a minor release focused on OpenAI product-surface
...
- Updated the package API guide in
  [docs/telic-package-api-guide.md](telic-package-api-guide.md).
- Updated the public API map in
  [docs/telic-public-api-v1.md](telic-public-api-v1.md).
- Updated the examples guide in
  [docs/telic-examples-guide.md](telic-examples-guide.md).
...
- PostgreSQL-backed examples when `TELIC_EXAMPLE_PG_DSN` is not usable
