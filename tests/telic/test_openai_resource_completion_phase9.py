...
import telic
from telic.model_catalog import get_default_model_catalog, model_profile_from_metadata
...
from telic.resources import ModelInfo, ProviderResourceAvailability, ResourcePage
...
def test_phase9_public_types_resolve_from_stable_namespaces() -> None:
    for name in (
        ...
        assert getattr(telic, name) is not None
