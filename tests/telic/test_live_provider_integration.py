...
async def test_live_openai_complete_smoke() -> None:
    _skip_unless_enabled("TELIC_LIVE_OPENAI", "OPENAI_API_KEY")
...
async def test_live_anthropic_complete_smoke() -> None:
    _skip_unless_enabled("TELIC_LIVE_ANTHROPIC", "ANTHROPIC_API_KEY")
...
async def test_live_google_complete_smoke() -> None:
    _skip_unless_enabled("TELIC_LIVE_GOOGLE", "GEMINI_API_KEY")
