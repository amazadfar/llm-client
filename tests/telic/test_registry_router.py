...
from telic.routing import ProviderHealthTracker, RegistryRouter, RoutingPreferences, RoutingRequirements
from telic.providers.types import Message
from telic.spec import RequestSpec
from telic.validation import ValidationError, validate_spec
...
def test_registry_router_honors_explicit_provider_alias(monkeypatch: pytest.MonkeyPatch) -> None:
    import telic.providers.google as google_mod
...
def test_registry_router_filters_by_structured_tool_capabilities(monkeypatch: pytest.MonkeyPatch) -> None:
    import telic.providers.anthropic as anthropic_mod
    import telic.providers.google as google_mod
    import telic.providers.openai as openai_mod
