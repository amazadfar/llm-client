"""
Telemetry and Observability for Telic.
...
class TelemetryConfig:
    ...
    # Histogram bucket boundaries in milliseconds for request/tool latency metrics.
    latency_buckets: tuple[float, ...] = (10.0, 25.0, 50.0, 100.0, 250.0, 500.0, 1000.0, 2500.0, 5000.0, 10000.0)
