"""
Unified hashing utilities for telic.
...
from .cache_keys import CACHE_KEY_SCHEMA_VERSION, build_cache_key
...
def cache_key(api: str, params: dict[str, Any]) -> str:
    ...
    This is the standard format used throughout telic for
    ...
    return build_cache_key("provider.api", payload, version=CACHE_KEY_SCHEMA_VERSION)
