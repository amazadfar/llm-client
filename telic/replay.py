...
class RunMetadata:
    ...
    def validate_compatibility(
        ...
        if strict:
            ...
            if self.telic_version != other.telic_version:
                issues.append(f"Telic version mismatch: {self.telic_version} vs {other.telic_version}")
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "telic_version": self.telic_version,
    ...
    def from_dict(cls, data: dict[str, Any]) -> RunMetadata:
        return cls(
            ...
            telic_version=data.get("telic_version"),
